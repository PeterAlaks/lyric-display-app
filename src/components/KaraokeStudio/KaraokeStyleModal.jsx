...
function KaraokeStyleEditor({ initialSettings, onSettingsChange }) {
  ...
  return (
    <div className="mx-auto w-full max-w-xl">
      <OutputSettingsPanel
        ...
        localMode
        title="KARAOKE VIDEO STYLE"
      />
    </div>
  );
}

export default function KaraokeStyleModal({
  open,
  settings,
  onSettingsChange,
  onClose,
