          ...
          <div
            ...
            {openMenu === 'tools' && (
              ...
              >
                ...
                <MenuItem ref={(el) => registerItemRef('tools', 2, el)} label="Karaoke Studio" onClick={menuHandlers.handleOpenKaraokeStudio} active={openMenu === 'tools' && activeIndex === 2} />
                <MenuItem ref={(el) => registerItemRef('tools', 3, el)} label="Connect Mobile Controller" onClick={menuHandlers.handleConnectMobile} disabled={isNewSongCanvas} active={openMenu === 'tools' && activeIndex === 3} title={isNewSongCanvas ? 'Only available in Control Panel' : undefined} />
                <Separator />
                ...
                <MenuItem ref={(el) => registerItemRef('tools', 5, el)} label="Pre-Service Health Check" onClick={menuHandlers.handlePreServiceHealth} active={openMenu === 'tools' && activeIndex === 5} />
