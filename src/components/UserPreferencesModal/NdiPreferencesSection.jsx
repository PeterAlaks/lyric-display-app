      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-2 text-xs">
        ...
        {ndiStatus.installed && (
          ...
          >
            ...
            {companionStarting
              ? t('preferences.ndi.status.starting')
              : companionRunning
                ? t('preferences.ndi.status.running')
                : t('preferences.ndi.status.stopped')}
          </span>
        )}
      ...
      {ndiStatus.installed && (
        ...
        >
          <div className="min-w-0 flex-1">
            <span className={`text-sm font-medium ${labelClass}`}>{t('preferences.ndi.telemetry.title')}</span>
          ...
          <span className={`shrink-0 text-xs ${mutedClass}`}>
            {!companionRunning ? t('preferences.ndi.status.stopped') : telemetryWarnings > 0 ? `${telemetryWarnings} warning${telemetryWarnings === 1 ? '' : 's'}` : 'View'}
          </span>
