...
Version: 5.8.0 | Windows 10/11 (64-bit)
...
**Windows:**
&nbsp;  [​Click here to download for Windows​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v5.8.0/LyricDisplay-5.8.0-Windows-Setup.exe)

**MacOS:**
&nbsp;  [​Click here to download for Apple Silicon (M1/M2/M3)​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v5.8.0/LyricDisplay-5.8.0-macOS-arm64.dmg)
&nbsp;  [​Click here to download for Intel Mac​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v5.8.0/LyricDisplay-5.8.0-macOS-x64.dmg)

**Linux:**
&nbsp;  [​Click here to download for Linux​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v5.8.0/LyricDisplay-5.8.0-Linux.AppImage)
