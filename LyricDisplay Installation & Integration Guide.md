...
Version: 5.9.12 | Windows 10/11 (64-bit)
...
**Windows:**
&nbsp;  [​Click here to download for Windows​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v5.9.12/LyricDisplay-5.9.12-Windows-Setup.exe)

**MacOS:**
&nbsp;  [​Click here to download for Apple Silicon (M1/M2/M3)​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v5.9.12/LyricDisplay-5.9.12-macOS-arm64.dmg)
&nbsp;  [​Click here to download for Intel Mac​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v5.9.12/LyricDisplay-5.9.12-macOS-x64.dmg)

**Linux:**
&nbsp;  [​Click here to download for Linux​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v5.9.12/LyricDisplay-5.9.12-Linux.AppImage)
