...
&nbsp;  [​Click here to download for MacOS​](https://github.com/PeterAlaks/lyric-display-app/releases/download/v5.8.0/LyricDisplay-5.8.0-macOS.dmg)
&nbsp;  Download: LyricDisplay-Setup.dmg
